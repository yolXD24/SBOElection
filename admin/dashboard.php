    ...
    <body id="page-top">
                                ...
                                <div class="card mb-3 " id="bdgtbl">
                                    ...
                                    <div class="card-body vtbl">
                                        <div class="table-responsive tbl1">
                                            ...
                                            <table class=" text-center table table-bordered" id="dataTable" width="100%"
                                                cellspacing="0">
                                                <thead>
                                    ...
                                    <div class="card mb-3" id="bdgtbl">
                                        ...
                                        <div class="card-body vtbl">
                                            <div class="table-responsive tbl1">
                                                ...
                                                <table id="2022list" class=" text-center table table-bordered"
                                                    id="dataTable">
                                                    <thead>
                                                        <tr class="table-striped">
                                                            <th>Voter Number</th>
                                            ...
                                            <div class="table-responsive tbl2">
                                                <h4 class="text-center">Batch 2021</h4>
                                                <br>
                                                <table id="2021list" class=" text-center table table-bordered"
                                                    id="dataTable">
                                                    <thead>
                                                        <tr class="table-striped">
                                                            <th>Voter Number</th>
        ...
        $(document).ready(function() {
            ...
            tbaleIt("configs/2021list.php",'#tbody2');      
            tbaleIt("configs/2022list.php",'#tbody1');      
